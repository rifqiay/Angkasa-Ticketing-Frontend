...
export const updateProfile = async (profileId = null, profileData = {}) =>
...
export const getTicketById = async (id = null) =>
  await axiosInstance.get(`${TICKET_PATH}/${id}`);
export const getIssuedTicketByTicketId = async (ticketId = null) =>
  await axiosInstance.get(`${TICKET_PATH}/check/${ticketId}`);
...
export const getBookingById = async (id = null) =>
  await axiosInstance.get(`${ORDER_PATH}/${id}`);
export const getBookingByBookingId = async (bookingId = null) =>
  await axiosInstance.get(`${ORDER_PATH}/booking/${bookingId}`);
export const bookingTicketById = async (id = null, bookingData = {}) =>
  await axiosInstance.post(`${ORDER_PATH}/booking/ticket/${id}`, bookingData);
export const payBookingByBookingId = async (bookingId = null) =>
